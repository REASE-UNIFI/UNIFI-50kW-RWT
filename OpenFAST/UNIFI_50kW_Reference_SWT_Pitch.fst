...
---------------------- INPUT FILES ---------------------------------------------
"ED_files\UNIFI_50kW_Reference_SWT_ED_primary_Pitch.dat"     EDFile          - Name of file containing ElastoDyn input parameters(quoted string)
"BD_files\UNIFI_50kW_Reference_SWT_BD_primary.dat"     BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"BD_files\UNIFI_50kW_Reference_SWT_BD_primary.dat"     BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"BD_files\UNIFI_50kW_Reference_SWT_BD_primary.dat"     BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"IF_files\UNIFI_50kW_Reference_SWT_IF_primary.dat"     InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
"SD_files\UNIFI_50kW_Reference_SWT_ServoDynROSCO.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
